...
// --- Scroll Reveal Logic (Added by Jaimin's request) ---
function reveal() {
    var reveals = document.querySelectorAll(".reveal");
    for (var i = 0; i < reveals.length; i++) {
        var windowHeight = window.innerHeight;
        var elementTop = reveals[i].getBoundingClientRect().top;
        var elementVisible = 100; // 100px scroll hone par dikhega
...
// Scroll hone par aur page load hone par animation trigger hogi
